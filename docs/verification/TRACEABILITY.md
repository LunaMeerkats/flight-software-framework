...
documented output for 0, 42, and 100 percent. The implementation commit reference
will be recorded after the local implementation commit. Existing evidence
hashes and their historical test counts below remain unchanged.
